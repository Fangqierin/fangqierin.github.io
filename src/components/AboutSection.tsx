    ...
    <div className="space-y-6">
      <div>
        ...
        <p className="text-slate-600 leading-relaxed mb-4">
          ...
          mobile wireless networks, mobile computing, cyber-physical systems, drones, and mobile sensing.
        </p>
      ...
      <div className="border-t border-slate-200 pt-6">
        ...
        <div className="flex flex-wrap gap-2">
          {['Internet of Things', 'Mobile Wireless Networks', 'Mobile Computing', 'Cyber-Physical Systems', 
            'Drone Systems', 'Mobile Sensing', 'Smart Cities', 'Emergency Response Systems'].map((interest, i) => (
